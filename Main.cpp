 ...
 */
const std::string kYourName = "Max";

/* Change these constants to contain the paths out of your mazes. */
const std::string kPathOutOfNormalMaze = "ESWSESWEENESNNNW";
const std::string kPathOutOfTwistyMaze = "WESSNWSSNN";
...
int main() {
    ...
    if (isPathToFreedom(startLocation, kPathOutOfNormalMaze, 0)) {
    ...
    if (isPathToFreedom(twistyStartLocation, kPathOutOfTwistyMaze, 0)) {
